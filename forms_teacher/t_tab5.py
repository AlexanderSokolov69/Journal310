...
"")
        ...
        self.horizontalLayout_6.addWidget(self.teachName)
        self.teachButton = QtWidgets.QPushButton(self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.teachButton.sizePolicy().hasHeightForWidth())
        self.teachButton.setSizePolicy(sizePolicy)
        self.teachButton.setMaximumSize(QtCore.QSize(30, 30))
        self.teachButton.setObjectName("teachButton")
        self.horizontalLayout_6.addWidget(self.teachButton)
    ...
    def retranslateUi(self, tab5Form):
        ...
        self.teachButton.setText(_translate("tab5Form", "<>"))
