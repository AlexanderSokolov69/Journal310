...
class Ui_tab4Form(object):
    def setupUi(self, tab4Form):
        ...
        self.verticalLayout_5.setContentsMargins(6, 6, 6, 2)
        ...
        self.tab4_count_lcd_3 = QtWidgets.QLCDNumber(self.frame_7)
        ...
        self.tab4_add_btn_3 = QtWidgets.QPushButton(self.frame_7)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.tab4_lmonts = QtWidgets.QComboBox(self.frame_7)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.tab4_rasp_user.addWidget(self.tableView)
        ...
        self.frame_3.setMaximumSize(QtCore.QSize(200, 1000))
        ...
        self.flt_user = QtWidgets.QComboBox(self.frame_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.flt_day = QtWidgets.QComboBox(self.frame_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.flt_kab = QtWidgets.QComboBox(self.frame_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
