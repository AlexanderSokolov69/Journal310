...
class Ui_tab4Form(object):
    def setupUi(self, tab4Form):
        ...
        self.frame_3.setMaximumSize(QtCore.QSize(150, 1000))
        ...
        self.filtersLayout.addWidget(self.label_2)
        self.flt_user = QtWidgets.QComboBox(self.frame_2)
        ...
        self.filtersLayout.addWidget(self.flt_user)
        ...
        self.filtersLayout.addWidget(self.label_4)
        self.flt_day = QtWidgets.QComboBox(self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.filtersLayout.addWidget(self.flt_day)
        ...
        self.filtersLayout.addWidget(self.label_5)
        self.flt_kab = QtWidgets.QComboBox(self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.filtersLayout.addWidget(self.flt_kab)
        ...
        self.filtersLayout.addWidget(self.frame_4)
        ...
        self.h_layout_table.setContentsMargins(1, -1, -1, -1)
