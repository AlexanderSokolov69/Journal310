...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("IT-куб3.PNG"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.MainTab.setTabPosition(QtWidgets.QTabWidget.TabPosition.North)
        ...
        self.line_3 = QtWidgets.QFrame(parent=self.tab1)
        self.line_3.setMaximumSize(QtCore.QSize(250, 16777215))
        self.line_3.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_3.setObjectName("line_3")
        self.verticalLayout_2.addWidget(self.line_3)
        self.listBox = QtWidgets.QComboBox(parent=self.tab1)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.add_Button)
        self.edit_Button = QtWidgets.QPushButton(parent=self.frame)
        self.edit_Button.setObjectName("edit_Button")
        self.buttonMainGroup.addButton(self.edit_Button)
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.edit_Button)
        self.del_Button = QtWidgets.QPushButton(parent=self.frame)
        self.del_Button.setObjectName("del_Button")
        self.buttonMainGroup.addButton(self.del_Button)
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.del_Button)
        self.label_2 = QtWidgets.QLabel(parent=self.frame)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_2)
        self.commit_Button = QtWidgets.QPushButton(parent=self.frame)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.commit_Button)
        self.rollback_Button = QtWidgets.QPushButton(parent=self.frame)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.rollback_Button)
        self.labelCur2 = QtWidgets.QLabel(parent=self.frame)
        self.labelCur2.setText("")
        self.labelCur2.setObjectName("labelCur2")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelCur2)
        self.labelCur1 = QtWidgets.QLabel(parent=self.frame)
        self.labelCur1.setText("")
        self.labelCur1.setObjectName("labelCur1")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.labelCur1)
        self.transLabel = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.transLabel.setFont(font)
        self.transLabel.setText("")
        self.transLabel.setObjectName("transLabel")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.transLabel)
        ...
        self.fltCheck = QtWidgets.QCheckBox(parent=self.frame_2)
        ...
        self.fltLabel1 = QtWidgets.QLabel(parent=self.frame_2)
        ...
        self.flt_fio = QtWidgets.QComboBox(parent=self.frame_2)
        self.flt_fio.setObjectName("flt_fio")
        self.verticalLayout_4.addWidget(self.flt_fio)
        self.fltLabel2 = QtWidgets.QLabel(parent=self.frame_2)
        ...
        self.fltCombo2 = QtWidgets.QComboBox(parent=self.frame_2)
        self.fltCombo2.setObjectName("fltCombo2")
        self.verticalLayout_4.addWidget(self.fltCombo2)
        self.fltLabel3 = QtWidgets.QLabel(parent=self.frame_2)
        ...
        self.fltCombo3 = QtWidgets.QComboBox(parent=self.frame_2)
        ...
        self.line_6 = QtWidgets.QFrame(parent=self.tab1)
        ...
        self.frame_3 = QtWidgets.QFrame(parent=self.tab1)
        self.frame_3.setMinimumSize(QtCore.QSize(0, 20))
        self.frame_3.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame_3.setObjectName("frame_3")
        self.verticalLayout_3.addWidget(self.frame_3)
        self.line_4 = QtWidgets.QFrame(parent=self.tab1)
        self.line_4.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_4.setObjectName("line_4")
        self.verticalLayout_3.addWidget(self.line_4)
        self.tableLabel = QtWidgets.QLabel(parent=self.tab1)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.line_5 = QtWidgets.QFrame(parent=self.tab1)
        self.line_5.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_5.setObjectName("line_5")
        self.verticalLayout_3.addWidget(self.line_5)
        self.editFrame = QtWidgets.QFrame(parent=self.tab1)
        self.editFrame.setMinimumSize(QtCore.QSize(0, 0))
        self.editFrame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.editFrame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.editFrame.setObjectName("editFrame")
        self.gridLayout = QtWidgets.QGridLayout(self.editFrame)
        self.gridLayout.setObjectName("gridLayout")
        self.buttonEditFrame = QtWidgets.QDialogButtonBox(parent=self.editFrame)
        ...
        self.buttonEditFrame.setFocusPolicy(QtCore.Qt.FocusPolicy.TabFocus)
        self.buttonEditFrame.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.buttonEditFrame.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.buttonEditFrame.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.No|QtWidgets.QDialogButtonBox.StandardButton.Save)
        ...
        self.records_label = QtWidgets.QLabel(parent=self.editFrame)
        ...
        self.tableView = QtWidgets.QTableView(parent=self.tab1)
        ...
        self.lcdNumber_Users = QtWidgets.QLCDNumber(parent=self.tab2)
        ...
        self.lcdNumber_Users.setFrameShape(QtWidgets.QFrame.Shape.Panel)
        self.lcdNumber_Users.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.lcdNumber_Users.setSmallDecimalPoint(False)
        self.lcdNumber_Users.setDigitCount(8)
        self.lcdNumber_Users.setSegmentStyle(QtWidgets.QLCDNumber.SegmentStyle.Flat)
        self.lcdNumber_Users.setObjectName("lcdNumber_Users")
        self.verticalLayout.addWidget(self.lcdNumber_Users)
        self.line_10 = QtWidgets.QFrame(parent=self.tab2)
        ...
        self.tab2_edit = QtWidgets.QPushButton(parent=self.tab2)
        ...
        self.tab2_del = QtWidgets.QPushButton(parent=self.tab2)
        ...
        self.tab2_add = QtWidgets.QPushButton(parent=self.tab2)
        ...
        self.frame_4 = QtWidgets.QFrame(parent=self.tab2)
        ...
        self.tab2_commit = QtWidgets.QPushButton(parent=self.tab2)
        ...
        self.tab2_commit.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.tab2_rollback = QtWidgets.QPushButton(parent=self.tab2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.line_11 = QtWidgets.QFrame(parent=self.tab2)
        ...
        self.line_9 = QtWidgets.QFrame(parent=self.tab2)
        ...
        self.frame_users = QtWidgets.QFrame(parent=self.tab2)
        self.frame_users.setMinimumSize(QtCore.QSize(0, 40))
        self.frame_users.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_users.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame_users.setObjectName("frame_users")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.frame_users)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.line_7 = QtWidgets.QFrame(parent=self.frame_users)
        ...
        self.line_8 = QtWidgets.QFrame(parent=self.frame_users)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.frame_users)
        ...
        self.tab2_buttonBox = QtWidgets.QDialogButtonBox(parent=self.frame_users)
        self.tab2_buttonBox.setMaximumSize(QtCore.QSize(200, 16777215))
        self.tab2_buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Save)
        ...
        self.tableView_Users = QtWidgets.QTableView(parent=self.tab2)
        font = QtGui.QFont()
        ...
        self.action_tab1 = QtGui.QAction(parent=MainWindow)
