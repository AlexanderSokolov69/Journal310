...
class Ui_tab5Form(object):
    def setupUi(self, tab5Form):
        ...
        self.commitButton = QtWidgets.QPushButton(parent=tab5Form)
...
"")
        ...
        self.rollbackButton = QtWidgets.QPushButton(parent=tab5Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.frame_2 = QtWidgets.QFrame(parent=tab5Form)
        ...
        self.teach_spisok = QtWidgets.QComboBox(parent=self.frame_2)
        font = QtGui.QFont()
        ...
        self.groupBox = QtWidgets.QComboBox(parent=self.frame_2)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.programName = QtWidgets.QLabel(parent=self.frame_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lcd_year = QtWidgets.QLCDNumber(parent=self.frame_2)
        self.lcd_year.setMinimumSize(QtCore.QSize(0, 30))
        self.lcd_year.setMaximumSize(QtCore.QSize(100, 16777215))
        self.lcd_year.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        ...
        self.frame_3 = QtWidgets.QFrame(parent=tab5Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lcd_cnt_grp = QtWidgets.QLCDNumber(parent=self.frame_3)
        self.lcd_cnt_grp.setMinimumSize(QtCore.QSize(0, 30))
        self.lcd_cnt_grp.setMaximumSize(QtCore.QSize(100, 16777215))
        self.lcd_cnt_grp.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lcd_cnt_grp.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.lcd_cnt_grp.setDigitCount(4)
        self.lcd_cnt_grp.setObjectName("lcd_cnt_grp")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lcd_cnt_grp)
        ...
        self.lcd_cnt_stud = QtWidgets.QLCDNumber(parent=self.frame_3)
        self.lcd_cnt_stud.setMinimumSize(QtCore.QSize(0, 30))
        self.lcd_cnt_stud.setMaximumSize(QtCore.QSize(100, 16777215))
        self.lcd_cnt_stud.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.lcd_cnt_stud.setDigitCount(4)
        self.lcd_cnt_stud.setObjectName("lcd_cnt_stud")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lcd_cnt_stud)
        ...
        self.lcd_cnt_week = QtWidgets.QLCDNumber(parent=self.frame_3)
        self.lcd_cnt_week.setMinimumSize(QtCore.QSize(0, 30))
        self.lcd_cnt_week.setMaximumSize(QtCore.QSize(100, 16777215))
        self.lcd_cnt_week.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.lcd_cnt_week.setDigitCount(4)
        self.lcd_cnt_week.setObjectName("lcd_cnt_week")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lcd_cnt_week)
        ...
        self.lcd_h_to_week = QtWidgets.QLCDNumber(parent=self.frame_3)
        self.lcd_h_to_week.setMinimumSize(QtCore.QSize(0, 30))
        self.lcd_h_to_week.setMaximumSize(QtCore.QSize(100, 16777215))
        self.lcd_h_to_week.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.lcd_h_to_week.setDigitCount(4)
        self.lcd_h_to_week.setObjectName("lcd_h_to_week")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lcd_h_to_week)
        ...
        self.lb_date_min = QtWidgets.QLabel(parent=self.frame_3)
        ...
        self.lb_date_min.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lb_date_min.setObjectName("lb_date_min")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lb_date_min)
        ...
        self.lb_date_max = QtWidgets.QLabel(parent=self.frame_3)
        ...
        self.lb_date_max.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lb_date_max.setObjectName("lb_date_max")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.lb_date_max)
        self.horizontalLayout_4.addLayout(self.formLayout)
        self.verticalLayout_2.addWidget(self.frame_3)
        self.frame_4 = QtWidgets.QFrame(parent=tab5Form)
        ...
        self.line_2 = QtWidgets.QFrame(parent=tab5Form)
        ...
        self.labelHead = QtWidgets.QLabel(parent=tab5Form)
        ...
        self.labelHead.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.labelHead.setObjectName("labelHead")
        self.verticalLayout_4.addWidget(self.labelHead)
        self.shape_frame = QtWidgets.QFrame(parent=tab5Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.shape_frame.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.shape_frame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.letter_place = QtWidgets.QFrame(parent=tab5Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.letter_place.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.letter_place.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.txt_comment = QtWidgets.QPlainTextEdit(parent=tab5Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.txt_comment.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.txt_comment.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.frame_5 = QtWidgets.QFrame(parent=tab5Form)
        ...
        self.test_label = QtWidgets.QLabel(parent=self.frame_5)
        ...
        self.line_3 = QtWidgets.QFrame(parent=tab5Form)
        self.line_3.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_3.setObjectName("line_3")
        self.horizontalLayout.addWidget(self.line_3)
        self.tableView = QtWidgets.QTableView(parent=tab5Form)
        ...
        self.frame = QtWidgets.QFrame(parent=tab5Form)
